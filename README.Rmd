...
[![R-CMD-check](https://github.com/drmowinckels/wbcmd/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/drmowinckels/wbcmd/actions/workflows/R-CMD-check.yaml)
[![Codecov test coverage](https://codecov.io/gh/drmowinckels/wbcmd/graph/badge.svg)](https://app.codecov.io/gh/drmowinckels/wbcmd)
<!-- badges: end -->
...
You can install the development version of wbcmd from [GitHub](https://github.com/drmowinckels/wbcmd) with:

```r
# install.packages("pak")
pak::pak("drmowinckels/wbcmd")
```
